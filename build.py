...
class InitiateBot:
    ...
    def setup(self):
        ...
        new_content = new_content.replace("{uid}", self.userid)
...
def main():
    ...
    print("")
    userid = input(colored("What is your own user ID? => ",'blue'))
    print("")
...
""",'green'))
    ...
    botinit = InitiateBot(token=token, prefix=prefix, userid=userid, guildid=guildid)
    botinit.setup()
